...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            <xd:p>antwoord Voorschrift afhandeling in FHIR</xd:p>

            <xd:p><xd:b>Created on:</xd:b> 2023-07-10</xd:p>
    ...
    <xsl:variable name="versionXSLT" as="xs:string">0.1.1</xsl:variable>
    <xsl:variable name="transformationCode" as="xs:string" select="'10.2'"/>
