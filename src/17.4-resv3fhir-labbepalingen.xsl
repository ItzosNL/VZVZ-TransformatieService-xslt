...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            <xd:p>MedMij gegevensdienst 49 in FHIR labbepalingen</xd:p>
            
            <xd:p><xd:b>Created on:</xd:b> 2024-02-26</xd:p>
    ...
    <xsl:variable name="transformationCode" as="xs:string" select="'17.4'"/>
