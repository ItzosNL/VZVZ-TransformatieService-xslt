...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            <xd:p>opleveren VerstrekkingsVerzoek in FHIR</xd:p>
            
            <xd:p><xd:b>Created on:</xd:b> 2023-06-13</xd:p>
    ...
    <xsl:variable name="transformationCode" as="xs:string" select="'15.2'"/>
